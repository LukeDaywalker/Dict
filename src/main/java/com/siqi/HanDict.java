...
public class HanDict {
	...
	public static URL getResource(String resourceName) {
		ClassLoader loader = HanDict.class.getClassLoader();
		URL url = loader.getResource(resourceName);
		return url;
	}
	private static void loadHanData() throws IOException, URISyntaxException {
		URL resUrl = getResource(HAN_DATA_FILE);
